...
class aapanel_api
{
    ...
    public function addSite($domain, $path, $desc, $type_id = 0, $type = 'php', $phpversion = '73', $port = '80', $ftp = null, $ftpusername = null, $ftppassword = null, $sql = null, $userdbase = null, $passdbase = null, $setSsl = 1, $forceSsl = 0)
    {
    ...
    public function addDatabase($database)
    {
        ...
        $data['password']   = 'HR2TjnPmbRx2HMXH';
        $data['dataAccess'] = 'ip';
        $data['address']    = '207.244.236.157';
        $data['ps']         = $database;
        $data['ssl']        = false;
    ...
    public function addFtp($path,$username)
    {
        $completeUrl    = $this->url . '/ftp?action=AddUser';

        $data                   = $this->encrypt();
        $data['ftp_username']   = $username;
        $data['ftp_password']   = 'HR2TjnPmbRx2HMXH';
        $data['path']           = '/home/wwwroot/'.$path;
        $data['ps']             = $username;
    ...
    public function installSetup($datafile, $path)
    {
        $completeUrl    = $this->url . '/files?action=UnZip';
